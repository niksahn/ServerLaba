...
# Скрипт для пересборки и деплоя AuthService в Kubernetes
# Использование: ./build-deploy-authservice.sh

set -e

SERVICE_NAME="authservice"
IMAGE_NAME="servers-authservice"
IMAGE_TAG="latest"
DEPLOYMENT_FILE="manifests/apps/authservice-deployment.yaml"
SERVICE_DIR="auth/AuthService"

echo "=== Пересборка и деплой AuthService ==="
...
kubectl rollout status deployment servers-authservice-1 -n microservices-lab --timeout=300s

echo "=== AuthService успешно пересобран и задеплоен ==="
